	<div class="panel panel-default">
			  ...
			  <div class="panel-body">
			    <ul class="nav nav-pills nav-stacked">
                  ...
                  <li role="presentation"><a href="nilai-awal.php"><span class="fa fa-hdd-o"></span> Nilai Awal</a></li>
				</ul>
			  </div>
			</div>
		  	<div class="panel panel-default">
			  <div class="panel-heading">
			    <h3 class="panel-title"><span class="fa fa-cogs"></span> Analisa Data AHP</h3>
			  </div>
			  <div class="panel-body">
			    <ul class="nav nav-pills nav-stacked">
		  	...
		  	<div class="panel panel-default">
			  <div class="panel-heading">
			    <h3 class="panel-title"><span class="fa fa-file-pdf-o"></span> Laporan</h3>
			  </div>
			  <div class="panel-body">
			    <ul class="nav nav-pills nav-stacked">
				  <li role="presentation"><a href="hasil-akhir.php"><span class="fa fa-list"></span> Rangking</a></li>
                 
                  <li role="presentation"><a href="laporan-cetak.php" target="_blank"><span class="fa fa-print"></span> Cetak Laporan</a></li>
